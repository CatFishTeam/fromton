...
return $this->privates['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
    yield 0 => ($this->privates['App\Security\GoogleAuthenticator'] ?? $this->load('getGoogleAuthenticatorService.php'));
    yield 1 => ($this->privates['App\Security\FacebookAuthenticator'] ?? $this->load('getFacebookAuthenticatorService.php'));
}, 2), ($this->privates['security.user.provider.concrete.database_users'] ?? $this->load('getSecurity_User_Provider_Concrete_DatabaseUsersService.php')), 'main', ($this->privates['security.user_checker'] ?? $this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker()));
