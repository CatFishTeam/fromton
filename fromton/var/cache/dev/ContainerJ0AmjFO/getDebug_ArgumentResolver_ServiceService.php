...
return $this->privates['debug.argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Controller\\FacebookController::connectAction' => function () {
    return ($this->privates['.service_locator.U56v430'] ?? $this->load('get_ServiceLocator_U56v430Service.php'));
}, 'App\\Controller\\GoogleController::connectAction' => function () {
    return ($this->privates['.service_locator.U56v430'] ?? $this->load('get_ServiceLocator_U56v430Service.php'));
...
}, 'App\\Controller\\FacebookController:connectAction' => function () {
    return ($this->privates['.service_locator.U56v430'] ?? $this->load('get_ServiceLocator_U56v430Service.php'));
}, 'App\\Controller\\GoogleController:connectAction' => function () {
    return ($this->privates['.service_locator.U56v430'] ?? $this->load('get_ServiceLocator_U56v430Service.php'));
}, 'App\\Controller\\RegistrationController:registerAction' => function () {
